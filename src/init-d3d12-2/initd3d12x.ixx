...
export namespace Test
{
	...
	template<WindowLike TWindow>
	class D3D12State
	{
	public:
		D3D12State(TWindow* window)
			: window(window)
		{
		}
	...
	public:
		...
		void Initialise(this D3D12xApp& self)
		{
	...
	private:
		using Window = AppWindow<D3D12xApp>;
		Window appWindow{this, 800, 600};
		D3D12State<Window> d3d12State{&appWindow};
	};
}
