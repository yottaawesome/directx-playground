		...
		*/
		...
		auto CreateSwapChain(this auto& self) -> decltype(auto)
		{
			...
			auto swapChainDesc = DXGI::DXGI_SWAP_CHAIN_DESC{
				.BufferDesc{
					.Width = self.GetDimensions().Width,
		...
		auto SetViewportAndScissorRect(this auto& self) -> decltype(auto)
		{
			auto viewport = D3D12::D3D12_VIEWPORT{
				.TopLeftX = 0.0f,
				.TopLeftY = 0.0f,
				.Width = static_cast<float>(self.GetWidth()),
				.Height = static_cast<float>(self.GetHeight()),
				.MinDepth = 0.0f,
				.MaxDepth = 1.0f
			};
			auto scissorRect = D3D12::D3D12_RECT{
				.left = 0,
				.top = 0,
				.right = static_cast<Win32::LONG>(self.GetWidth()),
				.bottom = static_cast<Win32::LONG>(self.GetHeight())
			};
			return self;
		}
